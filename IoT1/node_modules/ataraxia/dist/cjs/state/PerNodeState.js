...
class PerNodeState {
    constructor(group, name, options) {
        ...
        this.gossiper = new Gossiper_1.Gossiper(group, {
            intervalInMs: 30000,
...
exports.PerNodeState = PerNodeState;
//# sourceMappingURL=PerNodeState.js.map