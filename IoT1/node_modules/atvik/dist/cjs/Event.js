...
class Event {
    ...
    constructor(parent, options) {
        var _a;
        this.parent = parent;
        this.errorStrategy = (_a = options === null || options === void 0 ? void 0 : options.defaultErrorStrategy) !== null && _a !== void 0 ? _a : ErrorStrategy_1.rethrowErrors;
        this.subscribable = createSubscribable_1.createSubscribable({
