import { rethrowErrors } from './ErrorStrategy';
import { OverflowBehavior } from './EventIteratorOptions';
/**
 ...
 */
export function createAsyncSubscribable(options) {
    var _a;
    const subscribe = options.subscribe;
    const unsubscribe = options.unsubscribe;
    const defaultErrorStrategy = (_a = options.defaultErrorStrategy) !== null && _a !== void 0 ? _a : rethrowErrors;
...
function createAsyncIterator(subscribe, unsubscribe, options) {
    ...
    const behavior = (_b = options === null || options === void 0 ? void 0 : options.overflowBehavior) !== null && _b !== void 0 ? _b : OverflowBehavior.DropOldest;
    const queue = [];
    let current = null;
