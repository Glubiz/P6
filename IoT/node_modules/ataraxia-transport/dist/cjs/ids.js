...
exports.sameId = exports.noId = exports.generateId = exports.decodeId = exports.encodeId = void 0;
 ...
 */
function generateId() {
    const bytes = (0, randomBytes_1.randomBytes)(16);
...
function sameId(o1, o2) {
    if (o1.byteLength !== o2.byteLength)
        return false;
