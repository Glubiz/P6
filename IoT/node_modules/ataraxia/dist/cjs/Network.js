...
class Network {
    ...
    constructor(options) {
        ...
        this.networkIdBinary = (0, ataraxia_transport_1.generateId)();
        ...
        __classPrivateFieldGet(this, _Network_topology, "f").onUnavailable(n => {
            const encodedId = (0, ataraxia_transport_1.encodeId)(n.id);
        ...
        __classPrivateFieldGet(this, _Network_topology, "f").onData((id, type, data) => {
            const encodedId = (0, ataraxia_transport_1.encodeId)(id);
            const node = __classPrivateFieldGet(this, _Network_nodes, "f").get(encodedId);
            if (!node)
                return;
     ...
     */
    get networkId() {
        return (0, ataraxia_transport_1.encodeId)(this.networkIdBinary);
    }
    /**
