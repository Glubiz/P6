 ...
 */
class PeerPacketDecodingStream extends stream_1.Transform {
    constructor() {
        super({
            objectMode: true
        });
    ...
    _transform(chunk, encoding, callback) {
        ...
        while (this.buffer.length >= offset + 1) {
            ...
            if (this.buffer.length - offset < length + headerBytes)
                break;
            const start = offset + headerBytes;
            const data = this.buffer.slice(start, start + length);
            this.push((0, ataraxia_transport_1.decodeBinaryPeerMessage)(data));
            offset = start + length;
        }
        /*
...
exports.PeerPacketDecodingStream = PeerPacketDecodingStream;
/**
 ...
 *   buffer with packet
 */
function encodePeerPacket(type, data) {
    const encoded = (0, ataraxia_transport_1.encodeBinaryPeerMessage)(type, data);
...
exports.encodePeerPacket = encodePeerPacket;
//# sourceMappingURL=binaryStreams.js.map