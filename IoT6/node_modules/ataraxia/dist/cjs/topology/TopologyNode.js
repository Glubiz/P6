...
class TopologyNode {
     ...
     */
    get outgoingDebug() {
        return this.outgoing.map(e => (0, ataraxia_transport_1.encodeId)(e.target.id));
    }
    /**
     ...
     */
    get reachableDebug() {
        return Array.from(this.reachableVia.values()).map(e => (0, ataraxia_transport_1.encodeId)(e));
    }
    /**
